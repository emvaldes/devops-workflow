...
VARIABLE_DOCSTRINGS = {
    ...
    - Type: str
    - Usage: Used by parse_and_collect_user_inputs() to load structured argument configurations.
    """,
    "required_runtime_vars": """
    - Description: List of environment variables required for execution.
    - Type: list
    - Usage: Used to determine missing values and trigger user prompts.
    """,
}
