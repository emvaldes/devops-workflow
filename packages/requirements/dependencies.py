...
def backup_packages(file_path: str) -> None:
    """
...
def restore_packages(file_path: str) -> None:
    """
...
def migrate_packages(file_path: str) -> None:
    """
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default="./backup-packages.txt",
        help="Backup existing environment into packages-list"
    )
    parser.add_argument(
        "--restore-packages",
        dest="restore_packages",
        default="./restore-packages.txt",
        help="Restore archived packages list into environment"
    )
    parser.add_argument(
        "--migrate-packages",
        dest="migrate_packages",
        default="./migrate-packages.txt",
        help="Migrate legacy packages into new environment"
    )
    parser.add_argument(
        "--show-installed",
        action="store_true",
